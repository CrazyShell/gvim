...
if &bg != "dark"
 ...
 highlight SignColor ctermbg=white ctermfg=blue guibg=turquoise guifg=RoyalBlue3
endif

" ---------------------------------------------------------------------
"  Public Interface:
if !hasmapto('<Plug>Vm_toggle_sign')
  map <unique> <c-F1> <Plug>Vm_toggle_sign
